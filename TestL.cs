    ...
    void Update()
    {
            ...
            Model.transform.eulerAngles.y   >= 85 && Model.transform.eulerAngles.y   <= 95  )
        {
            ...
            if      (Softbox2.transform.position.x           <= -6   &&
                     UpperSoftbox1.transform.localPosition.y >= 18   && UpperSoftbox1.transform.localPosition.y <= 22  &&
                     ...
                     Softbox1.transform.position.z           >= 2.2  && Softbox1.transform.position.z           <= 3.3 &&
                     Softbox1.transform.eulerAngles.y        >= 30   && Softbox1.transform.eulerAngles.y        <= 40   )
            {
            ...
            //=================================================================================================
                     ...
                     HeadSoftbox1.transform.eulerAngles.z    >= 60   && HeadSoftbox1.transform.eulerAngles.z    <= 80   &&
                     Softbox1.transform.position.x           >= 2.2  && Softbox1.transform.position.x           <= 3.3  &&
                     Softbox1.transform.position.z           >= -3.3 && Softbox1.transform.position.z           <= -2.2 &&
            ...
            //=================================================================================================
                     ...
                     Softbox2.transform.position.z           >= 2.2  && Softbox2.transform.position.z           <= 3.3  &&
                     Softbox2.transform.eulerAngles.y        >= 30   && Softbox2.transform.eulerAngles.y        <= 40    )
            {
                TestIndicatorX.SetActive(false);
                TestIndicatorV.SetActive(true);
            }
            //=================================================================================================
                     ...
                     HeadSoftbox2.transform.eulerAngles.z    >= 60   && HeadSoftbox2.transform.eulerAngles.z    <= 80   &&
                     Softbox2.transform.position.x           >= 2.2  && Softbox2.transform.position.x           <= 3.3  &&
                     Softbox2.transform.position.z           >= -3.3 && Softbox2.transform.position.z           <= -2.2 &&
